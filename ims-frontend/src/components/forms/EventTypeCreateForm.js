...
export class EventTypeCreateForm extends Component {
...
submitFrom(e){
  ...
  axio.post('http://localhost:5000/api/event_type', event_typeObj)
       .then(res => {
  ...
  render() {
   ...
   <div className="form-group">
     <lable>EventType</lable>
     <input type="text" name="event_type" className="form-control" onChange={this.onChangeName} value={this.state.event_type} placeholder="EventType"/>
   </div>
